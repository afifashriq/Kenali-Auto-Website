...
<body>
    ...
    <form action="" method="GET" class="search-form">
        <input type="text" name="search" class="search-input" placeholder="Search by name or phone">
...
<div class="booking-success">
    ...
    <!-- Button to go to admin_login.php -->
    <a href="admin_login.php" class="btn-goto-admin"></a>
</div>
