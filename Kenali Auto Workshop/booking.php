...
<div class="offer">
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <img src="images/fortuner1.png" class="offer-img">
                    </div>
                    <div class="col-2">
...
<script>
    ...
    document.getElementById("bookingForm").addEventListener("submit", function(event) {
        ...
        .then(result => {
            // Display the popup message if booking is successful
            if (result.trim() === "Booking successful!") {
                showPopup();
                // You can redirect to another page after successful booking if needed
                // window.location.href = "success_page.php";
            }
            console.log(result); // Log the response (for testing)
        })
        .catch(error => {
